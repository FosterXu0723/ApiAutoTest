...
getdata = HandleYaml('/test_data/GroupInsurPlatForm_data/roleManage.yml').get_casename_step()
print(getdata)
...
class RoleManage(unittest.TestCase):
    ...
    def test_case(self, casename, caseno, step):
        result = api_send_check('/test_data/GroupInsurPlatForm_data/roleManage.yml', caseno, step)
