...
getdata = HandleYaml('/test_data/GroupInsurPlatForm_data/login.yml').get_casename_step()
print(getdata)
...
class Login(unittest.TestCase):
    ...
    def test_case(self, casename, caseno, step):
        result = api_send_check('/test_data/GroupInsurPlatForm_data/login.yml', caseno, step)
