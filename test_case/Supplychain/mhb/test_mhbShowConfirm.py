...
getdata = HandleYaml('/test_data/InsureController_data/mhb/mhbShowConfirm.yml').get_casename_step()
print(getdata)
...
class TestMhbSubmit(unittest.TestCase):
    ...
    def test_mhbSubmit(self, casename, caseno, step):
        result = api_send_check('/test_data/InsureController_data/mhb/mhbShowConfirm.yml', caseno, step)
